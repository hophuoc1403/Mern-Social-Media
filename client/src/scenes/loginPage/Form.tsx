...
const Form = () => {
  ...
  const handleLogin =async (values:loginProps,onSubmitProps:any) => {
    ...
    try{
      console.log("ok")
      const savedLoginResponse:any = await login({email:values.email,password:values.password})
  ...
  // @ts-ignore
  // @ts-ignore
  return <Box sx={{maxWidth:"700px",margin:"0 auto",border:`1px solid ${palette.primary.light}`}} p={3}>
    <Formik  initialValues={isLogin ? initialValueLogin : initialValueRegister} onSubmit={handleFormSubmit}
      ...
      {({
        ...
        (<form onSubmit={handleSubmit}>
          <Box  display={"grid"} gap={"30px"} gridTemplateColumns={"repeat(4,minmax(0,1fr)"}
            ...
            {isRegister && (<>
              <TextField label={"first name"} name={"firstName"} onBlur={handleBlur} value={values.firstName}
                         error={Boolean(touched.firstName) && Boolean(errors.firstName)}
                         helperText={
                           touched.firstName && errors.firstName
                         } onChange={handleChange}
                         sx={{gridColumn: "span 2"}}
              /> <TextField label={"last name"} name={"lastName"} onBlur={handleBlur} value={values.lastName}
                            error={Boolean(touched.lastName) && Boolean(errors.lastName)}
                            helperText={
                              touched.lastName && errors.lastName
                            } onChange={handleChange}
                            sx={{gridColumn: "span 2"}}
            /> <TextField label={"location"} name={"location"} onBlur={handleBlur} value={values.location}
                          error={Boolean(touched.location) && Boolean(errors.location)}
                          helperText={
                            touched.location && errors.location
                          } onChange={handleChange}
                          sx={{gridColumn: "span 4"}}
            /> <TextField label={"occupation"} name={"occupation"} onBlur={handleBlur} value={values.occupation}
                          ...
                          sx={{gridColumn: "span 4"}}
            />
              <Box gridColumn={"span 4"} border={`1px solid ${palette.background.default}`} borderRadius={"5px"}
                   p={"1rem"}>
            ...
            <TextField label={"email"} name={"email"} onBlur={handleBlur} value={values.email}
                       error={Boolean(touched.email) && Boolean(errors.email)}
                       helperText={
                         touched.email && errors.email
                       } onChange={handleChange}
                       sx={{gridColumn: "span 4"}}
            /> <TextField label={"password"} name={"password"} onBlur={handleBlur} value={values.password}
                          error={Boolean(touched.password) && Boolean(errors.password)} type={"password"}
                          helperText={
          ...
          <Box>
            <Button fullWidth type={"submit"} sx={{
              m: "2rem 0", p: "1rem", backgroundColor: palette.primary.light,
              color: palette.primary.dark, "&:hover": {color: palette.primary.main}
            }}>
